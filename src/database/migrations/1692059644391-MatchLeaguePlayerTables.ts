...
export class MatchLeaguePlayerTables1692059644391 implements MigrationInterface {
    name = 'MatchLeaguePlayerTables1692059644391'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "player" ("id" SERIAL NOT NULL, "points" integer NOT NULL DEFAULT '1000', "playerId" integer, CONSTRAINT "PK_65edadc946a7faf4b638d5e8885" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "player" ADD CONSTRAINT "FK_ee365af3f201a00d9a917bc45b0" FOREIGN KEY ("playerId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
